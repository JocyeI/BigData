...
![java-io-aio-3](Images/java-io-aio-3.png)
...
在测试过程中，启动了两个客户端(客户端用什么语言来写都行，用阻塞或者非阻塞方式也都行，只要是支持 TCP Socket套接字的就行，然后我们观察服务器端对这两个客户端通道的处理情况:
...
![java-io-aio-5](Images/java-io-aio-5.png)
