...
之所以把*TreeSet*和*TreeMap*放在一起讲解，是因为二者在Java里有着相同的实现，前者仅仅是对后者做了一层包装，也就是说***TreeSet里面有一个TreeMap*(适配器模式)**。因此将重点分析*TreeMap*。
...
![TreeMap_base](Images/TreeMap_base.png)
...
![TreeMap_rotateLeft](Images/TreeMap_rotateLeft.png)
...
![TreeMap_rotateRight](Images/TreeMap_rotateRight.png)
...
![TreeMap_successor](Images/TreeMap_successor.png)
...
![TreeMap_getEntry](Images/TreeMap_getEntry.png)
...
![TreeMap_put](Images/TreeMap_put.png)
...
![TreeMap_fixAfterDeletion](Images/TreeMap_fixAfterDeletion.png)
